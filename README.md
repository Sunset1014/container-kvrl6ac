...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kvrl6ac.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kvrl6ac.containers.anotherwebservice.com/
...
```
git clone git@github.com:Sunset1014/container-kvrl6ac.git
cd container-kvrl6ac
```
...
```
docker attach container-kvrl6ac
```
